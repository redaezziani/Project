            ...
            <div className="page">
                ...
                <div className="grid grid-cols-6 md:grid-cols-12 justify-center items-center gap-4">
                    ...
                    <div className="col-span-6">
                        {loading ? (
                                 <div className="animate-pulse rounded-lg w-full h-72 bg-gray-200">

                                 </div>
                        ) : (
                            <img
                            onLoad={handelLoding}
                            className='rounded-lg w-full h-full' src='https://idsb.tmgrup.com.tr/ly/uploads/images/2023/09/12/291752.jpg' />
                        )}
